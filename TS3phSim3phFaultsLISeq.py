...
eventIDFile = obj_dir + '/' + 'eventIDFileLISeq.txt'
voltFileName = obj_dir + '/' + 'vData3phLISeq.csv'
anglFileName = obj_dir + '/' + 'aData3phLISeq.csv'
timeDataFileName = obj_dir + '/' + 'tData3phLISeq.csv'
...
seqFlag = '-ts_seq_dir'
seqParam = 'test_cases/savnw/savnw_new.seq'


dyrFlag = '-ts_dyr_dir'
dyrParam = 'test_cases/savnw/savnw_dy_sol_0905.dyr'
...
for raw in RawFileList:
    ...
    for FaultBus in rawBusDataDict:
        ...
        for faultZ in ZFaultSim:
            ...
            EventList = [rawFlag, rawParam, dyrFlag, dyrParam, seqFlag, seqParam, event1Flag, event1Param, event2Flag, event2Param, exitFlag, exitParam]
