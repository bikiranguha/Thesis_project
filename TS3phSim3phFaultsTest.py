...
raw = 'test_cases/savnw/savnw_conz.raw'
FaultBus1 = '151'
FaultBus2 = '101'
# test case
event1Flag = '-event01'
...
faultType = 'AG'
faultZ = '1.0e-6'
rawFileName = 'savnw_conz'
EventList = [event1Flag, event1Param, event2Flag, event2Param, exitFlag, exitParam]
#tme = runSim(raw,EventList,TS3phLogFile,FaultBus1, faultType, eventFileObj, writerObjV, writerObjA)
tme = runSim(raw,EventList,TS3phLogFile,FaultBus1, faultType, eventFileObj, writerObjV, writerObjA,rawFileName,faultZ)

# single phase fault in phase A
event1Flag = '-event01'
event1Param = '0.1,FAULTON,AG,' + FaultBus2 + ',,,,1.0e-6,1.0e-6,1.0e-6,0.0,0.0,0.0'

event2Flag = '-event02'
event2Param = '0.2,FAULTOFF,AG,' + FaultBus2 + ',,,,,,,,,'
...
EventList = [event1Flag, event1Param, event2Flag, event2Param, exitFlag, exitParam]
#tme = runSim(raw,EventList,TS3phLogFile,FaultBus2, faultType, eventFileObj, writerObjV, writerObjA)
tme = runSim(raw,EventList,TS3phLogFile,FaultBus2, faultType, eventFileObj, writerObjV, writerObjA,rawFileName,faultZ)
