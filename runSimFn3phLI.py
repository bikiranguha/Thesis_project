...
Update from runSimFn3phLI: The fault impedance is also written to the key
...
def runSim(rawPath,EventList,TS3phLogFile,faultBus, faultType, eventFileObj, writerObjV, writerObjA,rawFileName, faultZ):
    ...
    for i in range(len(BusListInt)):
        ...
        # phase A
        eventID = 'R{}/F{}/B{}/{}/{}/{}'.format(PL ,faultBus, BusList[i], faultType,'A',faultZ)
        ...
        # phase B
        eventID = 'R{}/F{}/B{}/{}/{}/{}'.format(PL, faultBus, BusList[i], faultType,'B',faultZ)
        eventFileObj.write(eventID)
        eventFileObj.write('\n')
        ...
        # phase C
        eventID = 'R{}/F{}/B{}/{}/{}/{}'.format(PL, faultBus, BusList[i], faultType,'C',faultZ)
        eventFileObj.write(eventID)
        eventFileObj.write('\n')
