...
# the faults are classified according to their type only (not location). Steady state events are ignored.
    ...
    if phase == 'A':
        if faulttype == 'ABCG':
            ...
            if currentbus == faultbus: 
                ...
                eventTargetSLGA.append(5)   # SLG A fault 
...
for target in eventTargetSLGA:
    if target == 1:
        ...
        eventTargetSLGB.append(6)
        eventTargetSLGC.append(7)
