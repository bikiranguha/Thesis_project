...
def runSim(rawPath,EventList,TS3phLogFile,faultBus, faultType, eventFileObj, writerObjV, writerObjA):
    ...
    for i in range(len(BusListInt)):
        ...
        # phase A
        eventID = 'F{}/B{}/{}/{}'.format(faultBus, BusList[i], faultType,'A')
        ...
        # phase B
        eventID = 'F{}/B{}/{}/{}'.format(faultBus, BusList[i], faultType,'B')
        eventFileObj.write(eventID)
        eventFileObj.write('\n')
        ...
        # phase C
        eventID = 'F{}/B{}/{}/{}'.format(faultBus, BusList[i], faultType,'C')
        eventFileObj.write(eventID)
        eventFileObj.write('\n')
