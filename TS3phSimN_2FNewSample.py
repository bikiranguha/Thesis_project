...
vNameT = 'PFORNLSim/vTransient{}.csv'.format(i)
aNameT = 'PFORNLSim/aTransient{}.csv'.format(i)

eventsFileName = 'PFORNLSim/eventKeysPFORNL_{}.csv'.format(i)
...
vNameS = 'PFORNLSim/vSteady{}.csv'.format(i)
aNameS = 'PFORNLSim/aSteady{}.csv'.format(i)

#eventsFileName = 'PFORNLSim/eventKeys_{}.csv'.format(i)
...
with open('PFORNLSim/suspectFile{}.txt'.format(i),'w') as f:
